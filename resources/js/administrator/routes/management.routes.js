...
const managementRoutes = [
    ...
    },
    {
        exact: true,
        layout: DashboardLayout,
        path: APP_URL + "/recursos/agencias/nova-agencia",
        guard: AuthGuard,
        component: lazy(() =>
            import("../views/management/agency/AgencyCreateView")
        )
    },
    {
        exact: true,
    ...
    },
    {
        ...
        path:
            APP_URL +
            "/gestao-do-sistema/funcionarios/todos-funcionarios-angodoc",
        guard: AuthGuard,
        component: lazy(() =>
            import("../views/management/customer/CustomerListView")
        )
    },
    {
        exact: true,

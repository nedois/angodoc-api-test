    ...
    return (
        <Formik
            initialValues={{
                ...
                type: document.attributes.document_type || "",
                date_emission: document.attributes.date_emission || "",
                commentary: document.attributes.commentary || ""
            }}
            ...
            onSubmit={async (values, { resetForm, setErrors, setStatus, setSubmitting }) => {
                await axios
                    .put(`${API_OLD_URL}/documents/${id}`, values)
                    .then(resp => {
                        resetForm({ values });

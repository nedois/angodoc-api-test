    ...
    */
    ...
    'backend' => [
        ...
        'documents' => [
            ...
            'all_agency' => 'Tous les documents dans cette agence',
            'create' => 'Créer document',
            'deleted' => 'Documents suprimés',
            'edit' => 'Modifier document',
            'management' => 'Documents',
            'management_agency' => 'Documents dans cette agence',
            'recovered' => 'Documents recupérés',

            'table' => [
                'reference' => 'Reference',
                'type' => 'Type',
                'owner' => 'Propriétaire',
                'founded_by' => 'Trouvé par',
                'agency' => 'Agence',
                'created_by' => 'Créé par',
                'created_at' => 'Créé à',
        ...
        'agencies' => [
            'all' => 'Tous les agences',
            'create' => 'Créer agence',
            'deleted' => 'Agences suprimées',
            'edit' => 'Modifier agence',
            'management' => 'Agences',
            ...
            'table' => [
                ...
                'address' => 'Adresse',
                'created_at' => 'Créée le',
                'total' => 'agences au total'
            ],
        ],

        'finder' => [
            'management' => 'Trouveurs'
        ],
    ],

...
return [
    ...
    */
    ...
    'frontend' => [
        ...
        'questions' => [
            'description' => 'Trouvez ici les réponses aux questions les plus fréquemment posées sur ce service.',
            'what_is_angodoc' => 'Qu\'est-ce que l\'ANGODOC?',
            'definition' => 'ANGODOC est un outil en ligne qui vous permet de retrouver tout document perdu sur la voie publique.',
            'important' => [
                'title' => 'Important',
                'description' => 'Tout citoyen national ou étranger résidant en Angola est prié de remettre tout document trouvé sur la voie publique aux autorités compétentes pour procéder à son enregistrement.',
            ],
            'where_deliver_found_document' => [
                'title' => 'Où remettre les documents trouvés?',
                'paragraph_1' => '',
                'paragraph_2' => ''
            ]
        ],
        ...
        'agencies' => [
            'description' => 'Vous souhaitez devenir une agence ANGODOC? Ou connaître les agences déjà enregistrées?'
        ],

        'contact' => [
            'description' => 'Trouvez ici nos coordonnées.'
        ],

        'register' => [
            'description' => 'Ouvrez votre session ici.'
        ]
    ],
];

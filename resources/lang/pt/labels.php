...
return [
    ...
    'backend' => [
        ...
        'documents' => [
            ...
            'all_agency' => 'Todos documentos nesta agência',
            'create' => 'Criar documento',
            'deleted' => 'Documentos apagados',
            'edit' => 'Editar documento',
            'management' => 'Documentos',
            'management_agency' => 'Documentos nesta agência',
            'recovered' => 'Documentos recuperados',

            'table' => [
                'reference' => 'Referência',
                'type' => 'Tipo',
                'owner' => 'Proprietário',
                'founded_by' => 'Encontrado por',
                'agency' => 'Agência',
                'created_by' => 'Criado por',
                'created_at' => 'Criado em',
                'total' => 'documentos no total',
        ...
        'agencies' => [
            ...
            'deleted' => 'Agências excluídas',
            'edit' => 'Modificar agência',
            'management' => 'Agências',
            ...
            'table' => [
                ...
                'total' => 'agências no total'
            ],
        ],

        'finder' => [
            'management' => 'Encontradores'
        ],
    ],

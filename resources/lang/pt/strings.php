...
return [
    ...
    'frontend' => [
        ...
        'questions' => [
            'description' => 'Encontre aqui respostas para as perguntas mais frequentes sobre este serviço.',
            'what_is_angodoc' => 'O que é o ANGODOC?',
            'definition' => 'O ANGODOC é uma ferramenta online que permite-lhe encontrar qualquer documento perdido na via pública.',
            'important' => [
                'title' => 'Importante',
                'description' => 'Pede-se à todo cidadão nacional ou estrangeiro residente em Angola, a fazer entrega de qualquer documento achado na via pública para qualquer agência ANGODOC ou parceiro para se efectuar o registro.',
            ],
            'q1' => [
                'question' => 'Achei um documento na via pública o que fazer?',
                'answer' => 'Se encontrares um documento perdido na via pública, dirija-se imediatamente à um dos nossos parceiros mais próximo e faça a entrega. A lista de parceiros encontra-se no menu Agências.',
            ],
            'q2' => [
                'question' => 'Perdi um documento o que fazer?',
                'answer' => 'Se perderes algum documento, deverás aguardar 24 horas para começares a pesquisa-lo no nosso sistema de buscas.',
            ],
            'q3' => [
                'question' => 'Como pesquisar o meu documento?',
                'answer' => 'A pesquisa de qualquer documento perdido, é feito na página Inicial, digitando o número do documento no campo de buscas.',
            ],
            'q4' => [
            ...
            'q5' => [
                ...
                'answer' => 'Dirija-se ao endereço indicado no resultado da pesquisa, levando consigo uma prova de identidade para a recepção do documento perdido.',
            ],
            'q6' => [
                'question' => 'O sistema funciona em todas as províncias?',
                'answer' => 'O Sistema está disponível em todas as provínvias de angola.',
            ],
            'q7' => [
                'question' => 'Quero ser parceiro, o que fazer?',
                'answer' => 'Para ser um parceiro deve-se enviar um pedido para parceria@angodoc.ao',
            ],
            'q8' => [
                'question' => 'As minhas questões não estão alistadas aqui',
                'answer' => 'Se tiver alguma questão não alistada, por favor envie a sua questão para o suporte@angodoc.ao',
            ],
        ],

        'agencies' => [
            'description' => 'Deseja se tornar uma agência ANGODOC? Ou conhecer as agências já cadastradas?'
        ],
        ...
        'register' => [
            'description' => 'Inicie a sessão aqui.'
        ]
    ],
];

...
return [
    ...
    */
    ...
    'frontend' => [
        ...
        'questions' => [
            'description' => 'Find answers to the most frequently asked questions about this service here.',
            'what_is_angodoc' => 'What is Angodoc?',
            'definition' => 'ANGODOC is an online tool that allows you to find any document lost on the public road.',
            'important' => [
                'title' => 'Important',
                'description' => 'Every national or foreign citizen residing in Angola is asked to deliver any document found on the public road to the competent authorities to carry out its due registration.',
            ],
            'where_deliver_found_document' => [
                'title' => 'Where to deliver the documents found?',
                'paragraph_1' => '',
                'paragraph_2' => ''
            ]
        ],
        ...
        'agencies' => [
            'description' => 'Do you want to become an ANGODOC agency? Or know the agencies already registered?'
        ],

        'contact' => [
            'description' => 'Find our contact information here.'
        ],

        'register' => [
            'description' => 'Start your session here'
        ]
    ],
];
